...
const WhyUs: React.FC = () => {
  return (
    <Section id="why-us" className="bg-black py-16 md:py-24 relative">
      {/* Background Effects */}
      <div className="absolute top-0 left-1/4 w-72 md:w-96 h-72 md:h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-0 right-1/4 w-72 md:w-96 h-72 md:h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse" />
