  ...
  return (
    <Section id="services">
      <div className="relative">
        {/* Section Title */}
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-10 sm:mb-14 lg:mb-20">
          ...
          <motion.h2
            ...
            className="text-[1.9rem] sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight"
          >
        ...
        {/* Mobile Carousel */}
        <div className="block lg:hidden relative min-h-[320px] overflow-visible px-1 sm:px-2">
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              <motion.div
                ...
                className="relative h-[80%] min-h-[240px] overflow-hidden rounded-2xl bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 p-5 sm:p-6 group hover:border-blue-500/30 transition-all duration-300 cursor-pointer"
              >
