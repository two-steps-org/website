  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        />
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[200vw] aspect-square bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-blue-500/10 rounded-full blur-[100px] animate-[pulse_4s_cubic-bezier(0.4,0,0.6,1)_infinite]" />
        <div className="absolute bottom-1/4 left-1/2 -translate-x-1/2 w-[200vw] aspect-square bg-gradient-to-br from-purple-500/10 via-blue-500/10 to-purple-500/10 rounded-full blur-[100px] animate-[pulse_4s_cubic-bezier(0.4,0,0.6,1)_infinite] delay-[2s]" />
