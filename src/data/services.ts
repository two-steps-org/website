...
export const services: Service[] = [
  {
    ...
    details: {
      ...
      useCase: "Perfect for businesses looking to automate customer support and engagement while maintaining a personal touch."
    }
  },
  {
    icon: Mic,
    ...
    details: {
      ...
      useCase: "Ideal for businesses needing to handle high call volumes while maintaining quality and consistency."
    }
  },
  {
    ...
    details: {
      ...
      useCase: "For businesses that need a CRM solution tailored to their unique processes and requirements."
    }
  },
  {
    icon: Code2,
    ...
    details: {
      ...
      useCase: "Perfect for businesses needing specialized software solutions that off-the-shelf products can't provide."
    }
  }
];